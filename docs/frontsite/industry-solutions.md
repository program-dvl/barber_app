# Industry and business-type decisions

Status: Implemented and locally verified in Prompt 18 (2026-08-16)

| Candidate | Distinct operational need and proof | Overlap | Disposition |
| --- | --- | --- | --- |
| Barbershop | Mixed booked/walk-in demand, evidence-based queue, staff assignment, fast linked checkout (FR-06/08/14) | Distinct from appointment-led salon | `/solutions/barbershops` |
| Salon | Multi-service/provider/processing visits, client context and policy snapshots (FR-04–FR-14) | Hair/beauty salon intents overlap | `/solutions/salons`; hair/beauty consolidated |
...
visible limitations, requirement evidence, breadcrumb, canonical and trial
CTA. There are no local/city routes, stereotypes, stock imagery, customer
claims, regulatory advice or industry-specific demos.
