            ...
            <div class="mx-auto max-w-7xl px-3 py-3 sm:px-6 lg:px-8">
                <div class="flex flex-wrap items-center justify-between">
                    <div class="flex min-w-0 flex-1 items-center">
                        <span class="flex rounded-lg p-2" :class="{ 'bg-success/80': style == 'success', 'bg-error/80': style == 'danger' }">
                        ...
                        <p class="ms-3 truncate text-sm font-medium text-white" v-html="message"></p>
                    </div>
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="{ 'hover:bg-success/80 focus:bg-success/80': style == 'success', 'hover:bg-error/80 focus:bg-error/80': style == 'danger' }"
                            aria-label="Dismiss"
