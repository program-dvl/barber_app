...
<template>
    <PublicBookingLayout title="Waitlist opening" mode="self-service">
        <p class="text-xs font-semibold uppercase tracking-[0.12em] text-[var(--action-primary)]">Time-limited waitlist offer</p><h1 class="cd-display mt-2 text-4xl text-[var(--text-strong)]">An opening is available</h1><p class="mt-3 text-[var(--text-muted)]">{{ business }} · {{ location }}</p>
