...
<template>
    <AppLayout title="Subscription & billing" :business-label="businessLabel">
        <PageHeader eyebrow="Account" title="Subscription & billing" description="Choose the right operating plan for your shop. Payment stays inside a secure ClipperDesk checkout page.">
